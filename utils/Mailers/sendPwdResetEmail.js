...
const sendPwdResetEmail = async (userRecipient, userName, token) => {
    ...
    try {
        ...
        <a target = "_" href="${process.env.DOMAIN}/auth/VerifyResetPwd/${token}"> to reset your password 
        </a> </p>
        <p> Thank you</p>`
        ...
        return { success: true, result: `Check your emails to reset your password!` }
