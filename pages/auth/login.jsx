...
const Login = ({}) => {
    ...
    return (
        <>
            <div
                className="flex justify-evenly align-middle gap-y-6 mx-auto items-center gap-x-4 bg-tertiary 
                 max-w-xs sm:max-w-md md:max-w-xl lg:max-w-2xl xl:max-w-3xl 2xl:max-w-4xl"
            >
