...
const LoginOrRegisterForm = ({
    ...
    } = router // Deep destructuring + alias
    ...
    const validStyling = field => {
        if (formik.errors[field] && formik.touched[field]) {
            return {
                ...
                message: <span className="text-red-600">{formik.errors[field]}</span>,
            }
        } else {
            // if no error on this specific field...
                ...
                <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                    ...
                    <div className="md:w-1/2 px-8 md:px-16">
                        ...
                        >
                            <div className="">
                                <input
                                    ...
                                    placeholder="Email"
                                />
                                <div>{validStyling('email').message}</div>
                            </div>
                            ...
                            {action === 'Register' && (
                                <div className="">
                                    ...
                                    />
                                    <div>{validStyling('name').message}</div>
                                </div>
                            )}
                                ...
                                <div>
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`p-2 rounded-xl border w-full ${
                                                validStyling('password2Field').border
                                            }`}
                                            type={isPwdVisible ? 'text' : 'password'}
                                            name="password2Field"
                        ...
                        <div className="mt-3 text-xs flex justify-between items-center text-[#002D74]">
                            ...
                            <Link
                                href={`/auth/${
                                    action === 'Register' ? 'SignIn' : 'Register'
                                }`}
                            >
                                <button
