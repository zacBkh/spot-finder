...
export default function ModalReviews({ children, isModalOpen, onModalClose }) {

    const cancelButtonRef = useRef(null)

    return (
        <Transition.Root show={isModalOpen} as={Fragment}>
            <Dialog as="div" className="relative z-10" /* initialFocus={cancelButtonRef} */ onClose={onModalClose}>
                <Transition.Child
                    as={Fragment}
                        ...
                        >
                            ...
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    ...
                                    <button type="button" class=" mr-auto text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100">
                                        <BsImages />
                                    </button>
